package com.validpic.app.data.repository
...
object FeedbackManager {
    ...
    suspend fun submitFeedback(
        ...
        try {
            val diagnosticInfo = "ValidPic v$versionName ($versionCode), Android ${Build.VERSION.RELEASE} (API ${Build.VERSION.SDK_INT}), ${Build.MANUFACTURER} ${Build.MODEL}"
